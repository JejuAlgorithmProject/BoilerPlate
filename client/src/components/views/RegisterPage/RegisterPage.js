    ...
    return (
        ...
        >
            <form style={{display: 'flex', flexDirection: 'column'}} onSubmit={onSubmitHandler}>
                ...
                <SignUp_Input type="email" value={Email} onChange={onEmailHandler} placeholder="Email" />
                <label>Name</label>
                {/* <input type="text" value={Name} onChange={onNameHandler} /> */}
                <SignUp_Input type="text" value={Name} onChange={onNameHandler} placeholder="Name" />
                <label>Password</label>
                {/* <input type="password" value={Password} onChange={onPasswordHandler} /> */}
                <SignUp_Input type="password" value={Password} onChange={onPasswordHandler} placeholder="Password" />
        ...
        /> */}
                <SignUp_Input type="password" value={ConfirmPassword} onChange={onConfirmPasswordHandler} placeholder="Confirm Password" />
                <br />
