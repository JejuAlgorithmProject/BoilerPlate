          ...
          <Card>
            ...
            <div style={{ margin: '1rem' }}>
              <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '0.5rem' }}>
                <div style={{ flex: '1', padding: '0.3rem', backgroundColor: '#CCB997', borderRadius: '5px', marginRight: '0.5rem' }}>
              ...
              <div style={{ padding: '0.3rem', fontSize: '1rem', backgroundColor: '#F2DCB3', borderRadius: '5px', marginBottom: '0.5rem' }}>
                {Post.title}
              </div>
